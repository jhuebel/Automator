...
<div class="p-6 space-y-4">
    <div class="border-b border-gray-200">
        <nav class="flex gap-6 -mb-px">
            @foreach (['application' => 'Application', 'users' => 'Users', 'runners' => 'Runners', 'groups' => 'Runner Groups', 'sso' => 'Single Sign-On', 'ai' => 'AI Assistant', 'status' => 'System Status', 'audit' => 'Audit Logs'] as $key => $label)
                <button
                    type="button"
    ...
    @elseif ($tab === 'groups')
        <livewire:settings.runner-group-management />
    @elseif ($tab === 'sso')
